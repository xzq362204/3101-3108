...
class TouchpadTest(test_case.TestCase):
  ...
  ARGS = [
      ...
      Arg('number_to_click', int, 'Target number to click.', default=2),
      Arg('number_to_quadrant', int,
          'Target number to click for each quadrant.', default=1),
      Arg('x_segments', int, 'Number of X axis segments to test.', default=3),
      Arg('y_segments', int, 'Number of Y axis segments to test.', default=3)]
